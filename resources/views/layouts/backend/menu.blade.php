...
@role('staff|approval-admin|ketua_unit|penolong_pengarah|ketua_pengarah')
  <div class="menu-item">
    <a class="menu-link {{ request()->routeIs('staff.launcher') ? 'active' : '' }}"
       href="{{ route('staff.launcher') }}">
...
<div class="menu-item">
  <a class="menu-link {{ request()->routeIs('admin.dashboard') ? 'active' : '' }}"
    ...
    <span class="menu-icon">🏠</span>
    <span class="menu-title">Dashboard Pentadbir</span>
  </a>
</div>
@endrole
